"""
Django settings for proyectoMEGA project.
...
ROOT_URLCONF = 'proyectoMEGA.urls'
...
WSGI_APPLICATION = 'proyectoMEGA.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'appMEGA/static')
